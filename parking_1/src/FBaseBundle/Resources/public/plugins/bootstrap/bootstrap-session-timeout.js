...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            $('body').append('<div class="modal fade session-modal" id="session-timeout-dialog"> \
        ...
        if (!opt.ignoreUserActivity) {
            ...
            $(document).not('.modal-dialog').on('keyup mouseup mousemove touchend touchmove', function(e) {
                if (e.type === 'mousemove') {
        ...
        function startSessionTimer(notKeep = false) {
         ...
         //   console.log(timer);
            ...
            timer = setTimeout(function() {
                ...
                $.ajax({
                    ...
                    if($.isNumeric(result)) {
                       // console.log('lastUsed 2: '+lastUsed);
        ...
        // Start session timer
        startSessionTimer();
        //setInterval(checkSession, opt.keepAliveInterval);
